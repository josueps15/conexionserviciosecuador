        ...
        <section className="px-6 space-y-6">
            <div className="flex items-end justify-between">
                <div className="space-y-1">
                    ...
                    <h2 className="text-2xl font-black font-outfit uppercase tracking-tight text-white leading-none">
            ...
            <div className="grid grid-cols-2 gap-4">
                {SERVICE_CATEGORIES.map((cat, i) => (
                    ...
                    >
                        <div className={`absolute inset-0 bg-gradient-to-br ${cat.bg} rounded-3xl border ${cat.border} opacity-50 group-active:opacity-100 transition-opacity`} />
            ...
            <button className="w-full py-4 bg-white/5 border border-white/10 rounded-2xl text-slate-400 font-bold uppercase tracking-widest text-[10px] flex items-center justify-center gap-2 active:bg-white/10 transition-all">
