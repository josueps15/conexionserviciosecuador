...
export const ContainerScroll = ({
    ...
    return (
        <div
            className="h-[50rem] md:h-[55rem] flex items-center justify-center relative p-2 md:p-10"
            ref={containerRef}
        >
            <div
...
export const Card = ({
    ...
    return (
        <motion.div
            ...
            className="max-w-7xl -mt-12 mx-auto h-[36rem] md:h-[48rem] w-full border-4 border-[#1a1a1a] p-2 md:p-4 bg-[#0a0a0a] rounded-[30px] shadow-2xl relative"
        >
