            ...
            <section id="inicio" className="relative pt-32 pb-40 px-6 md:px-12 lg:px-24 min-h-screen flex items-center overflow-hidden bg-[var(--app-bg)] transition-colors duration-500">
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center w-full relative z-10 px-12">
                    ...
                    >
                        ...
                        {/* Social Proof Stats */}
                        <div className="mt-16 flex items-center gap-12 pt-12 border-t border-[var(--card-border)]">
                            <div className="text-center md:text-left">
                                <p className="text-4xl font-bold text-[var(--app-text)] font-outfit">50+</p>
                                <p className="text-[10px] uppercase font-black tracking-widest text-[var(--app-text-muted)]">Categorías</p>
                            </div>
                            <div className="text-center md:text-left">
                                <p className="text-4xl font-bold text-[var(--app-text)] font-outfit">100%</p>
                                <p className="text-[10px] uppercase font-black tracking-widest text-[var(--app-text-muted)]">Verificados</p>
                            </div>
                            <div className="text-center md:text-left">
                                <p className="text-4xl font-bold text-[var(--app-text)] font-outfit">24</p>
                                <p className="text-[10px] uppercase font-black tracking-widest text-[var(--app-text-muted)]">Provincias</p>
                            </div>
                        </div>
                    </motion.div>
                ...
                <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 z-20">
                    <motion.div 
                        ...
                        className="w-1 h-8 bg-gradient-to-b from-[var(--primary)] to-transparent rounded-full" 
                    />
                </div>
            </section>
