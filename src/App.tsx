    ...
    return (
        <div id="root-app" className="relative min-h-screen bg-slate-950 text-slate-50 selection:bg-primary selection:text-white overflow-x-hidden" style={{ opacity: 1 }}>
            ...
            <footer className="bg-[#01030B] border-t border-white/5 py-10 px-6">
                ...
                {/* Footer WhatsApp Button section */}
                <div className="max-w-7xl mx-auto pt-8 flex justify-center md:justify-end border-t border-white/5 relative z-10">
                    <a
                        href="https://wa.me/593979783184?text=Hola,%20me%20gustaría%20recibir%20más%20información%20sobre%20Conexión%20Servicios."
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group flex items-center justify-center gap-3 px-8 py-4 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold rounded-xl shadow-lg shadow-[#25D366]/20 transition-all hover:scale-105 active:scale-95 w-full md:w-auto overflow-hidden relative"
                    >
                        ...
                        <span className="relative z-10 drop-shadow-sm tracking-wide">Contáctanos por WhatsApp</span>
                    </a>
                </div>

                <div className="max-w-7xl mx-auto pt-6 mt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-slate-600 text-xs">
